...
namespace Blip
{
    ...
    {
        [System.Serializable]
        public class VolumeByDistance : BlipAction
        {
            ...
            public override void Apply(BlipEmitter[] emitters, int emitterIndex)
            {
                ...
                emitters[emitterIndex].SetVolumeByDistance
                (
                    MinRange, 
                    MaxRange
                );
...
#if UNITY_EDITOR
        [CustomPropertyDrawer(typeof(VolumeByDistance))]
        public class BlipActionVolumeByDistanceInspector : PropertyDrawer
        {
